...
abstract class oledrion_gateway {
	 ...
	 *
	 * @param string $gatewaysLogPath Le chemin d'acc�s complet (et le nom) au fichier log
	 * @param string $text Le texte � �crire
	 * @return void
	 */
	 ...
	 * @return string
	 */
	abstract function getRedirectURL($order = null);
