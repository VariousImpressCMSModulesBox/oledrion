...
function oledrion_adminMenu($currentoption = 0, $breadcrumb = '') {
	...
	require ICMS_ROOT_PATH . '/modules/oledrion/admin/menu.php';
	...
	echo "<a href=\"../index.php\">" . _AM_OLEDRION_GO_TO_MODULE . "</a> | <a href=\"" . ICMS_URL . "/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod=" . $xoopsModule->getVar('mid') . "\">" . _AM_OLEDRION_PREFERENCES . "</a> | <a href='index.php?op=maintain'>" . _AM_OLEDRION_MAINTAIN . "</a>\n";
	echo "</td>\n";
	...
	foreach ($tabs as $key => $link) {
		...
		echo "<a href=\"" . ICMS_URL . "/modules/oledrion/" . $link['link'] . "\"><span>" . $link['title'] . "</span></a>\n";
		echo "</li>\n";
	}
	echo "</ul>\n";
	echo "</div>\n";
