...
switch ($op) {
	...
	// ****************************************************************************************************************
        ...
        if(oledrion_utils::isX23()) {
            $url = ICMS_URL.'/modules/system/admin.php?fct=blocksadmin&selmod=-1&selvis=-1&selgrp=2&selgen='.$xoopsModule->getVar('mid');
        } else {
            $url = ICMS_URL.'/modules/system/admin.php?fct=blocksadmin';
        }
