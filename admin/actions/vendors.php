...
/**
 * Actions relatives aux vendeurs (affichage, �dition, suppression)
 */
...
switch ($action) {
	...
	case 'default': // Gestion des vendeurs
		...
		foreach ($vendors as $item) {
			...
			echo "<tr class='" . $class . "'>\n";
			echo '<td>' . $id . "</td><td align='center'>" . $item->getVar('vendor_name') . "</td><td align='center'>" . implode(' ', $actions) . "</td>\n";
			echo "<tr>\n";
		}
		$class = ($class == 'even') ? 'odd' : 'even';
		echo "<tr class='" . $class . "'>\n";
	...
	// ****************************************************************************************************************
	case 'saveedit': // Sauvegarde d'un vendeur (�dition et ajout)
	                  // ****************************************************************************************************************
		xoops_cp_header();
	...
	case 'delete': // Suppression d'un vendeur
		...
		$opRedirect = 'vendors';
		// On v�rifie que ce vendeur n'est pas rattach� � des produits
