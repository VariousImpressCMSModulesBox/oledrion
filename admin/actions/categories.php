...
switch ($action) {
	// ****************************************************************************************************************
	case 'default': // Liste des cat�gories
	                 // ****************************************************************************************************************
		xoops_cp_header();
	...
	// ****************************************************************************************************************
	case 'add': // Ajout d'une cat�gorie
	case 'edit': // Edition d'une cat�gorie
	              // ****************************************************************************************************************
		xoops_cp_header();
		oledrion_adminMenu(3);
	...
	// ****************************************************************************************************************
	case 'saveedit': // Sauvegarde d'une cat�gorie
	                  // ****************************************************************************************************************
		xoops_cp_header();
		...
		if ($res) {
			...
			if ($add) {
				...
				$plugins->fireAction(oledrion_plugins::EVENT_ON_CATEGORY_CREATE, new oledrion_parameters(array(
					'category' => $item)));
			}
	...
	// ****************************************************************************************************************
	case 'delete': // Suppression d'une cat�gorie
	                // ****************************************************************************************************************
		xoops_cp_header();
		oledrion_adminMenu(3);
		$id = isset($_POST['id']) ? intval($_POST['id']) : 0;
	...
	// ****************************************************************************************************************
	case 'confdelete': // Suppression effective d'une cat�gorie
	                    // ****************************************************************************************************************
		xoops_cp_header();
		$id = isset($_POST['id']) ? intval($_POST['id']) : 0;
		if (empty($id)) {
		...
		$opRedirect = 'categories';
		// On v�rifie que cette cat�gorie (et ses sous-cat�gories) ne sont pas utilis�es par des produits
