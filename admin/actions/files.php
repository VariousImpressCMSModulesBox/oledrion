...
/**
 * Gestion des fichiers attach�s aux produits (dans l'administration)
 */
...
switch ($action) {
	// ****************************************************************************************************************
	case 'default': // Gestion des fichiers attach�s
	                 // ****************************************************************************************************************
		xoops_cp_header();
		...
		$itemsCount = $h_oledrion_files->getCount(); // Recherche du nombre total d'�l�ments
		if ($itemsCount > $limit) {
	...
	// ****************************************************************************************************************
	case 'saveedit': // Sauvegarde d'un fichier attach�
	                  // ****************************************************************************************************************
		xoops_cp_header();
