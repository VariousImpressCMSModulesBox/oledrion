...
/**
 * Affiche la liste des produits recommand�s
 */
require 'header.php';
...
// R�cup�ration du nombre total de produits publi�s dans la base
...
if ($limit > 0) {
	// R�cup�ration de la liste des produits r�cents
...
$xoopsTpl->assign('breadcrumb', oledrion_utils::breadcrumb(array(
	OLEDRION_URL . basename(__FILE__) => _OLEDRION_RECOMMENDED)));
