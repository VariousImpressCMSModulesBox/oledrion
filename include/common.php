...
if (!defined("OLEDRION_DIRNAME")) {
	...
	define("OLEDRION_URL", ICMS_URL . '/modules/' . OLEDRION_DIRNAME . '/');
	define("OLEDRION_PATH", ICMS_ROOT_PATH . '/modules/' . OLEDRION_DIRNAME . DIRECTORY_SEPARATOR);
...
require_once OLEDRION_PLUGINS_PATH . 'models' . DIRECTORY_SEPARATOR . 'oledrion_action.php'; // mod�le
require_once OLEDRION_PLUGINS_PATH . 'models' . DIRECTORY_SEPARATOR . 'oledrion_filter.php'; // mod�le

// Les classes m�tier ou utilitaires (non ORM)
...
$oledrion_shelf = new oledrion_shelf(); // Fa�ade
$oledrion_shelf_parameters = new oledrion_shelf_parameters(); // Les param�tres de la fa�ade
...
// Chargement de quelques pr�f�rences
$mod_pref = array(
