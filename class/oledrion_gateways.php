...
/**
 * Classe charg�e de la manipulation des passerelles de paiement
 *
 * Normalement la classe est utilisable de mani�re statique
 */
...
class oledrion_gateways {
	 ...
	 *
	 * @return string Le nom de la passerelle de paiement (en fait le nom de son r�pertoire)
	 */
	function getCurrentGateway() {
		$return = xoops_trim(oledrion_utils::getModuleOption('used_gateway'));
		if ($return == '') {
			$return = 'paypal'; // Valeur par d�faut
		}
		return $return;
	}
	...
	/**
	 * Retourne la liste des passerelles de paiement install�es
	 *
	 * @return array
	 */
	...
	/**
	 * Retourne le chemin d'acc�s � une passerelle de paiement
	 *
	 * @param string $gatewayName Le nom de la passerelle de paiement (son r�pertoire)
	 * @return string
	 */
	 ...
	 * @return boolean True si le chargement a r�ussi sinon Faux
	 */
	...
	/**
	 * Retourne le chemin d'acc�s complet � une passerelle de paiement
	 *
	 * @param string $gatewayName Le nom de la passerelle de paiement (son r�pertoire)
	 * @return string
	 */
	 ...
	 *
	 * @param object $gateway L'objet � v�rifier
	 * @return boolean
	 */
	...
	/**
	 * Raccourcis pour r�cup�rer l'objet gateway courant
	 *
