...
define('OLEDRION_CACHE_LITE_ERROR_RETURN', 1);
define('OLEDRION_CACHE_LITE_ERROR_DIE', 8);
...
class oledrion_Cache_Lite
{
    ...
    */
    public $_pearErrorMode = OLEDRION_CACHE_LITE_ERROR_RETURN;
    ...
    */
    ...
    /**
     * API break for error handling in OLEDRION_CACHE_LITE_ERROR_RETURN mode
     *
     * In OLEDRION_CACHE_LITE_ERROR_RETURN mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in OLEDRION_CACHE_LITE_ERROR_RETURN mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', OLEDRION_CACHE_LITE_ERROR_DIE);
    }
