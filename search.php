...
$limit = oledrion_utils::getModuleOption('newproducts'); // Nombre maximum d'�l�ments � afficher
...
if ((isset($_POST['op']) && $_POST['op'] == 'go') || isset($_GET['start'])) { // Recherche des r�sultats
	...
	} else { // $_GET['start'] est en place, on a cliqu� sur un chevron pour aller voir les autres pages, il faut travailler � partir des informations de la session
