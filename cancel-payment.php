...
/**
 * Page appel�e par la passerelle de paiement dans le cas de l'annulation d'une commande
 */
require 'header.php';
...
// On donne la possibilit� � la passerelle d'annuler la commande
$gateway = null;
...
$xoopsTpl->assign('breadcrumb', oledrion_utils::breadcrumb(array(
	OLEDRION_URL . basename(__FILE__) => _OLEDRION_ORDER_CANCELED)));
