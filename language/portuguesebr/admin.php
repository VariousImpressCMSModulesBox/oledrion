...
define("_AM_OLEDRION_ADD", "Incluir");

define("_AM_OLEDRION_PARENT_CATEG", "Categoria Principal");
define("_AM_OLEDRION_CURRENT_PICTURE", "Foto atual");
define("_AM_OLEDRION_CURRENT_FILE", "Arquivo Atual");
define("_AM_OLEDRION_PICTURE", "Foto");
define("_AM_OLEDRION_DESCRIPTION", "Descrição");

define("_AM_OLEDRION_ALL", "Tudo");
...
define("_AM_OLEDRION_IMAGE1_CHANGE", "Alterar foto dos produtos");
define("_AM_OLEDRION_IMAGE2_CHANGE", "Alterar fotos do thumb");
define("_AM_OLEDRION_ATTACHED_HLP", "");
define("_AM_OLEDRION_CATEG_HLP", "Categoria de Produtos");
define("_AM_OLEDRION_CATEG_TITLE", "Título da Categoria");
define("_AM_OLEDRION_URL_HLP", "Url dos Produtos (opcional)");
define("_AM_OLEDRION_SELECT_HLP", "Use a tecla Control (ou a tecla maçã no Mac) para selecionar mais de um item");
define("_AM_OLEDRION_STOCK_HLP", "Um e-mail será enviado a um grupo quando a quantidade é inferior ...");
define("_AM_OLEDRION_DISCOUNT_HLP", "Preço promocional (temporário) sem VAT");
define("_AM_OLEDRION_DISCOUNT_DESCR", "Descrição do desconto (para o cliente)");
define("_AM_OLEDRION_DATE", "Data");
define("_AM_OLEDRION_CLIENT", "Cliente");
define("_AM_OLEDRION_TOTAL_SHIPP", "Total / Remessa");
...
define('_AM_OLEDRION_CSV_EXPORT', "Exportação ordens no seguinte formato ");
define('_AM_OLEDRION_EXPORT_READY', "Sua exportação de arquivo está pronta, para fazer o download, clique neste link para baixa-lo");
define('_AM_OLEDRION_CSV_READY', "Seu arquivo CSV está pronto para download, clique neste link para baixa-lo");
define('_AM_OLEDRION_NEW_QUANTITY', "Nova quantidade");
define('_AM_OLEDRION_UPDATE_QUANTITIES', "Atualizar quantidades");
define('_AM_OLEDRION_NEWSLETTER_READY', "O seu boletim informativo está pronto, clique neste link para obtê-lo");
define('_AM_OLEDRION_DUPLICATED', "Duplicada");

// Added on 14/04/2007 17:11
define('_AM_OLEDRION_SORRY_NOREMOVE', "Desculpe, mas não podemos retirar esse produto porque ele é parte de algumas encomendas");
define('_AM_OLEDRION_CONF_VALIDATE', "Você realmente deseja validar esta ordem?");
define('_AM_OLEDRION_LAST_ORDERS', "Últimas Ordens");
define('_AM_OLEDRION_LAST_VOTES', "Últimos Votos");
define('_AM_OLEDRION_NOTE', "Nota");

define('_AM_OLEDRION_RECOMMEND_IT', "Recomendar");
define('_AM_OLEDRION_DONOTRECOMMEND_IT', "Pare de recomendar");
define('_AM_OLEDRION_RECOMMENDED', "Recomendado");
define('_AM_OLEDRION_RECOMM_TEXT', "Texto a ser exibido em recomendações<br />páginas de produtos");
define('_AM_OLEDRION_META_KEYWORDS', "Meta keywords");
define('_AM_OLEDRION_META_DESCRIPTION', "Meta descrição");
define('_AM_OLEDRION_META_PAGETITLE', "Título das Páginas");

// Added in March & April 2008
define('_AM_OLEDRION_FILENAME', "Arquivo");
define('_AM_OLEDRION_VISIBLE_FILENAME', "Nome do arquivo visível para o usuário");
define('_AM_OLEDRION_OFFLINEPAY_TEXT', "Texto a ser exibido para o usuário quando ele/ela escolher que não deseja o pagamento online?");
define('_AM_OLEDRION_FOOTER', "Texto a ser exibido no rodapé da categoria");

define('_AM_OLEDRION_RESTRICT_TEXT', "Texto a ser exibido quando as ordens são restritas aos usuários registrados");

// Pour les réductions
define("_AM_OLEDRION_DISCOUNT_INFORMATION", "Informação de Descontos");
define("_AM_OLEDRION_DISCOUNT_TITLE", "Título do Desconto (usado internamente)");
define("_AM_OLEDRION_DISCOUNT_DESCRIPTION", "Descrição do Desconto (para seus clientes)");
...
define("_AM_OLEDRION_DISCOUNT_PRODUCT", "Produto");
define("_AM_OLEDRION_DISCOUNT_REDUCTION_PRICE", "Redução no preço dos produtos ou o montante da ordem de pagamento");
define("_AM_OLEDRION_DISCOUNT_REDUCTION_TYPE", "Aplicar a redução");
...
define("_AM_OLEDRION_DISCOUNT_ALL_CASES", "Em todos os casos");
define("_AM_OLEDRION_DISCOUNT_FIRST_PURCHASE", "Se esta é a primeira compra do cliente no site");
...
define("_AM_OLEDRION_DISCOUNT_REDUCED_FOR", "Porcentagens são reduzidas em");
...
define("_AM_OLEDRION_DISCOUNT_HELP6", "Se você especificar um produto apenas, somente este produto poderá se beneficiar desta redução.");
?>