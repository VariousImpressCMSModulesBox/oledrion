...
$modversion['author'] = "Herv� Thouzard of Instant Zero (http://www.instant-zero.com)";
$modversion['credits'] = "Don Curioso, Voltan, Bezoops, Mariane Antoun, Defkon1, Feichtl, Carlos P�rez, JardaR and all the other";
$modversion['help'] = '';
...
$modversion['blocks'][$cptb]['options'] = '10|0|0'; // Voir 10 produits, pour toutes les cat�gories, uniquement les produits du mois ?
...
$modversion['blocks'][$cptb]['options'] = '0'; // 0 = en relation avec la page, 1=classique, 2=D�pli�
...
$modversion['blocks'][$cptb]['options'] = '10|0'; // Voir 10 produits, pour toutes les cat�gories
...
$modversion['blocks'][$cptb]['options'] = '1|0|0'; // Nombre de produits, cat�gorie, produits du mois uniquement ?
...
$modversion['blocks'][$cptb]['description'] = "Shows Recently Sold products";
...
$modversion['blocks'][$cptb]['options'] = '10'; // Nombre maximum de produits � voir
...
$modversion['blocks'][$cptb]['description'] = "Shows recent public lists";
...
$modversion['blocks'][$cptb]['options'] = '10|0'; // Nombre maximum de listes � voir, Type de listes (0 = les 2, 1 = liste cadeaux, 2 = produits recommand�s)
...
$modversion['blocks'][$cptb]['description'] = "Shows user's lists";
$modversion['blocks'][$cptb]['show_func'] = 'b_oledrion_my_lists_show';
$modversion['blocks'][$cptb]['edit_func'] = 'b_oledrion_my_lists_edit';
$modversion['blocks'][$cptb]['options'] = '10'; // Nombre maximum de listes � afficher
...
$modversion['blocks'][$cptb]['description'] = "Shows recent public lists according to the current category";
...
$modversion['blocks'][$cptb]['description'] = "Shows random lists";
...
$modversion['blocks'][$cptb]['description'] = "Shows most viewd lists";
...
// Ajout des cat�gories m�res en sous menu ********************************************************
global $xoopsModule;
 ...
 * move your mouse over an article's title.
 ...
 * of each item.
 * The first link will enable you to go to the previous
...
$modversion['config'][$cpto]['title'] = "Gateway used by the module";
$modversion['config'][$cpto]['description'] = '';
$modversion['config'][$cpto]['formtype'] = 'hidden';
$modversion['config'][$cpto]['valuetype'] = 'text';
