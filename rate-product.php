...
// Faut il afficher les produits m�me lorsqu'ils ne sont plus en stock ?
...
if (!empty($_POST['btnsubmit'])) {
	...
	if ($canRate) {
		...
		// Calcul du nombre de votes et du total des votes pour mettre � jour les informations du produit
		$totalVotes = 0;
		$sumRating = 0;
		$ret = 0;
	...
	$breadcrumb = array(
		$product->getLink() => $product->getVar('product_title'),
